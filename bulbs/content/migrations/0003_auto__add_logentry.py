...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'content_logentry', (
            ...
            ('content', self.gf('django.db.models.fields.related.ForeignKey')(related_name='change_logs', to=orm['content.Content'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='change_logs', to=orm['accounts.User'])),
    ...
    models = {
        ...
        u'content.logentry': {
            ...
            'content': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'change_logs'", 'to': u"orm['content.Content']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
