...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'content_logentry', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.User']))

        # Changing field 'Content.image'
        db.alter_column(u'content_content', 'image', self.gf('bulbs.images.fields.RemoteImageField')(max_length=512, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'LogEntry.user'
        raise RuntimeError("Cannot reverse this migration. 'LogEntry.user' and its values cannot be restored.")

        # Changing field 'Content.image'
        db.alter_column(u'content_content', 'image', self.gf('bulbs.images.fields.RemoteImageField')(max_length=100, null=True))
