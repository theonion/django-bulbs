...
from .views import instant_article_rss, instant_article, instant_article_analytics, instant_article_ad
...
urlpatterns = patterns("",
    ...
    url(r"^instant_article/(?P<pk>\d+)/analytics$", instant_article_analytics, name="instant_article_analytics"),
