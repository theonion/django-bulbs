...
class Migration(migrations.Migration):
    ...
    dependencies = [
        migrations.swappable_dependency(get_liveblog_author_model_name()),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authors', models.ManyToManyField(to=get_liveblog_author_model_name())),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', models.TextField(blank=True)),
                ('author', models.ForeignKey(to=get_liveblog_author_model_name())),
