...
class BaseSuperFeatureMetadata(SimpleMetadata):

    # TODO: Move fields into common file
    @property
    ...
    def get_serializer_info(self, serializer):
        serializer_info = super(BaseSuperFeatureMetadata, self).get_serializer_info(serializer)
