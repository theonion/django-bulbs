...
urlpatterns = patterns("",
    ...
    # url(r"^(?P<pk>\d+)/inline-recirc", "bulbs.recirc.views.inline_recirc", name="inline_recirc"),
    ...
    url(r"^series/(?P<slug>[\w-]+)/?$", "bulbs.videos.views.series_detail", name="series_detail"),
