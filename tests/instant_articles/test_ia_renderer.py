...
class InstantArticleRendererTests(BaseIndexableTestCase):
    ...
    def test_render_imgur(self):
        ...
        output = self.renderer.render_imgur(block['imgur'])
        self.assertEqual(
            output.replace('\n', ''),
    ...
    def test_render_onion_video(self):
        ...
        output = self.renderer.render_onion_video(block['onion_video'])
        self.assertTrue(
            output.replace('\n', ''),
    ...
    def test_render_soundcloud(self):
        ...
        output = self.renderer.render_soundcloud(block['soundcloud'])
        self.assertTrue(
            output.replace('\n', ''),
    ...
    def test_render_vimeo(self):
        ...
        output = self.renderer.render_vimeo(block['vimeo'])
        self.assertTrue(
            output.replace('\n', ''),
