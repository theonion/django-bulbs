...
class InstantArticleRendererTests(TestCase):
    ...
    def test_render_facebook(self):
        ...
        self.assertEqual(
            output.replace('\n', ''),
            '<figure class="op-interactive"><iframe src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2Fsarahpalin%2Fposts%2F10154115152888588&width=500" width="500" height="603" scrolling="no" frameborder="0" allowTransparency="true"></iframe></figure>'
        )
    ...
    def test_render_instagram(self):
        ...
        self.assertEqual(
            output.replace('\n', ''),
            '<figure class="op-interactive"><iframe class="instagram-media instagram-media-rendered" id="instagram-embed-0" src="https://www.instagram.com/p/3ewOSHitL2/embed/captioned/?v=7" allowtransparency="true" frameborder="0"></iframe></figure>'
        )
    ...
    def test_render_onion_video(self):
        ...
        self.assertEqual(
            output.replace('\n', ''),
            '<figure class="op-interactive"><iframe src="http://onionstudios.com/embed?id=3040" class="onionstudios-playlist" allowfullscreen="" webkitallowfullscreen="" mozallowfullscreen="" frameborder="no" width="560" height="315" scrolling="no"></iframe></figure>'
        )
    ...
    def test_render_soundcloud(self):
        ...
        self.assertEqual(
            output.replace('\n', ''),
            '<figure class="op-interactive"><iframe width="100%" height="450" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/119434855%3Fsecret_token%3Ds-Dv1kg&amp;color=ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false"></iframe></figure>'
        )
    ...
    def test_render_vimeo(self):
        ...
        self.assertEqual(
            output.replace('\n', ''),
            '<figure class="op-interactive"><iframe src="https://player.vimeo.com/video/166544005" width="640" height="360" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""></iframe></figure>'
        )
    ...
    def test_render_youtube(self):
        ...
        self.assertEqual(
            output.replace('\n', ''),
            '<figure class="op-interactive"><iframe width="560" height="315" src="https://www.youtube.com/embed/2vnd49" frameborder="0" allowfullscreen></iframe></figure>'
        )
